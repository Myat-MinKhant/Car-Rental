export default function Footer() {
    return (
        <>
            <section className=" w-[80vw] m-auto mt-32 pt-10 pb-32 flex gap-10 border-t-zinc-500  border-b-2 border-b-main">
            ...
            <div className=" w-[80vw] m-auto flex justify-end mt-5 mb-20">
