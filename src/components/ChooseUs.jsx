    ...
    return (
        <section className=" w-full desktop:w-[90vw] laptop:flex mt-32 px-3">
            ...
            <div className=" w-full mt-5 text-center tablet:m-auto tablet:w-2/3 laptop:text-left ">
                ...
                <div className=" w-full flex flex-col mt-20 gap-20 laptop:w-[75%] tablet:gap-10 tablet:pl-12 laptop:pl-0 laptop:gap-10">
                    <div className=" tablet:flex items-center gap-10 tablet:text-left">
                        <img src={bestprice} alt="price-icon" width={70} className=' m-auto mb-7 tablet:m-0' />
                        <div>
                    ...
                    <div className=" tablet:flex items-center tablet:text-left gap-10">
                        <img src={driver} alt="driver-icon" className=' m-auto mb-7 tablet:m-0' />
                        <div>
                    ...
                    <div className=" tablet:flex items-center gap-10 tablet:text-left">
                        <img src={clock} alt="24/7-icon" width={60} className=' m-auto mb-7 tablet:m-0' />
                        <div>
                    ...
                    <div className=" tablet:flex items-center gap-10 tablet:text-left">
                        <img src={chat} alt="contact-icon" width={60} className=' m-auto mb-7 tablet:m-0' />
                        <div>
